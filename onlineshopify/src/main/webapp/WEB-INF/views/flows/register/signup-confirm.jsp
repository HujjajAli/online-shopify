			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					...
					<div class="text-center">
						...
						<h4>${registerModel.user_Detail.firstName} ${registerModel.user_Detail.lastName}</h4>
						<hr>
						<h5>Email: ${registerModel.user_Detail.email}</h5>
						
						<h5>Contact Number: ${registerModel.user_Detail.contact}</h5>
						
						<h5>Role: ${registerModel.user_Detail.role}</h5>
			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					...
					<div class="text-center">
						...
						<h4>${registerModel.billing.stateOrprovince} - ${registerModel.billing.country}</h4>
					</div>
				</div>
				<div class="panel-footer">
