			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<sf:form method="POST" class="form-horizontal" id="billingForm" modelAttribute="billing">
						...
						<div class="form-group">
							<label class="control-label col-md-4" for="stateOrprovince">State/Province</label>
							<div class="col-md-8">
								<sf:input type="text" path="stateOrprovince" class="form-control" placeholder="Enter State/Province Name" />
								<sf:errors path="stateOrprovince" cssClass="help-block" element="em"/>
							</div>
						</div>
						<div class="form-group">
