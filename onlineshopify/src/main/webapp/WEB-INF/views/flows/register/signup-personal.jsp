		...
		<div class="col-md-6 col-md-offset-3">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<sf:form method="POST" class="form-horizontal" id="registerForm" modelAttribute="user_detail">
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<sf:input type="text" path="contact" class="form-control" placeholder="XXXXXXXXXX" maxlength="11" />
